    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <ul class="list-inline dashboard-menu text-center">
          ...
          <li><a href="address.html">Address</a></li>
          <li><a class="active"  href="account">Profile Details</a></li>
           <li><a href="myorders">My Orders</a></li>
        </ul>
        <div class="dashboard-wrapper dashboard-user-profile">
          <div class="media">
            <div class="pull-left text-center" href="#!">
              <img class="media-object user-img" src="https://i.pinimg.com/736x/0a/53/c3/0a53c3bbe2f56a1ddac34ea04a26be98.jpg" alt="Image">
           ...
           <c:if test="${not empty uid}">
              <ul class="user-profile-list">
                ...
                <li><span>ID:</span><c:out value="${uid}"></c:out></li>
                <li><span>Full Name:</span><c:out value ="${profile.userName}"> </c:out></li>
                <li><span>Email:</span><c:out value ="${profile.emailId}"></c:out></li>
                <li><span>Phone:</span><c:out value ="${profile.mobile}"> </c:out></li>
