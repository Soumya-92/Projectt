      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          <a class="logo" href="index">
            <img src="https://thumbs.dreamstime.com/b/cafe-resto-logo-vector-icon-design-178204126.jpg" style="height:150px; width: 200px;" alt="">
          </a>
          ...
          <h4>${err}</h4>
            ...
            <div class="form-group">
              <input type="text" class="form-control"  placeholder="First Name" name ="fullname" value ="${param.fullname}">
              ...
              <input type="text" class="form-control"  placeholder="Mobile" value ="${param.mobile}"name = "mobile">
