...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name" style="color:white" >Checkout</h1>
					<ol class="breadcrumb">
						<li><a href="First.jsp" style="color:white">Home</a></li>
						<li class="active" style="color:white">checkout</li>
					</ol>
				</div>
			</div>
		</div>
               ...
               <div class="product-checkout-details">
                  <div class="block">
                     ...
                     <ul class="summary-prices">
                        <li>
                           <span>Subtotal:</span>
                           <span class="price"><c:out value ="${pr.price*pr.quantity}"> </c:out>&nbsp; &nbsp;<br>
