...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name" style="color:white">Dashboard</h1>
					<ol class="breadcrumb">
						<li><a href="index" style="color:white">Home</a></li>
						<li class="active" style="color:white">my account</li>
					</ol>
				</div>
			</div>
		</div>
							...
							<tbody>
                             ...
                             <c:forEach var="ord" items="${ords}">
								<tr>
									...
									<!-- <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#collapse${ord.orderid}"  >VIEW</button>
                                     <div id="collapse${ord.orderid}" class="collapse" >-->
                                                       
					<div class="panel-group commonAccordion" id="accordion" role="tablist" aria-multiselectable="true">
					  	<div class="panel panel-default">
						    <div class="panel-heading" role="tab" id="headingOne">
                                     <h4 class="panel-title">
                                      <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse${ord.orderid}" aria-expanded="true" aria-controls="collapseOne">VIEW</a>
                                     </h4>
						   
					    <div id="collapse${ord.orderid}" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								...
								<a href="order.html" class="btn btn-default"><tr>
									<td>#451231</td>
									<td>Mar 25, 2016</td>
									<td>3</td>
									<td>$150.00</td>
