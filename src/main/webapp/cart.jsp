			...
			<div class="col-md-4 col-xs-12 col-sm-4">
				...
				<ul class="top-menu text-right list-inline">
					<li class="dropdown cart-nav dropdown-slide">
						<a href="viewcart" <c:out value="${cart.size()}"> </c:out> class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"><i
                    ...
                    <tr class="">
                      <td class="">
                        <div class="product-info">
                          <img width="80" src="${pr.base64Image}" width="200" height="100"  />
                          <c:out value ="${pr.name}"> </c:out> 
                        </div>
                      </td>
                      <td class=""><c:out value ="${pr.price}"></c:out></td>
                      <td class=""><c:out value ="${pr.quantity}"> </c:out></td>
                        
                        <td class=""> <c:out value ="${pr.price*pr.quantity}"> </c:out>
                        <c:set var="total" value="${total+pr.price*pr.quantity}"></c:set></td>
                        
                      <td class="">
                      <a class ="product=add" href ="addimage?id=${pr.id}" target="_blank">AddImage</a>
                      </td>
                      <td class="">
                      <a class="product-remove" href="#!">Remove</a></td>
                    </tr>
